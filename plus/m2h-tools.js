$(function () {
    ...
    // make html-strip tool work (same as html-decode)
    //
    ...
    mkTool(
        ...
        function () {
            ...
            var str = '';
            for (var i = 0; i < howMany; i++) {
                var randByte = parseInt(Math.random() * 256, 10).toString(16);
